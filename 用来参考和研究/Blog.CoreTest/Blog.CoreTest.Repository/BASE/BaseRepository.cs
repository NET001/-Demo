...
using Blog.CoreTest.Model;
using Blog.CoreTest.Repository.UnitOfWork;
using SqlSugar;
using System;
...
namespace Blog.CoreTest.Repository.BASE
{
    /// <summary>
    /// DTO实现类,SqlSugar的操作模式是首先进行实体填装操作产生一个具体的装填好的实体，然后在通过操作实体来进行提交
    /// </summary>
    ...
    public class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class, new()
    {
        ...
        /// <param name="lstIgnoreColumns">不需要更新的列</param>
